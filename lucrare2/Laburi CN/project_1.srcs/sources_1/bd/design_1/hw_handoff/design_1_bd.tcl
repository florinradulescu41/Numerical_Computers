...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Op1_0_1 [get_bd_ports a] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net Op2_0_1 [get_bd_ports b] [get_bd_pins util_vector_logic_1/Op2]
  connect_bd_net -net Op2_1_1 [get_bd_ports c] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins ila_0/clk]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports out1] [get_bd_pins ila_0/probe0] [get_bd_pins util_vector_logic_0/Res]
